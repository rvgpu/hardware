...
`ifndef RVGPU_JOB_CLUSTER_BLOCK_SVH
`define RVGPU_JOB_CLUSTER_BLOCK_SVH
...
function automatic string job_cluster_to_string(
...
`endif // RVGPU_JOB_CLUSTER_BLOCK_SVH 